...
export function Card({
  ...
  return (
    ...
    >
      <div className="absolute -inset-y-6 -inset-x-4 z-0 scale-95 bg-blue-200 opacity-0 transition group-hover:scale-100 group-hover:opacity-100 dark:bg-zinc-800/50 sm:-inset-x-6 sm:rounded-2xl" />
      {children}
    </Component>
  );
}
