...
npm run seed
```
For a working example of how to seed your database using TypeORM Seeding, you can refer to the [GitHub repository](https://github.com/testingfly/typeorm-seeding/tree/main#readme). The repository provides a practical implementation of the concepts discussed in this article.
